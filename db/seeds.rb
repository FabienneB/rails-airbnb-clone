...
my_cowork_1 = Cowork.new(city: "San-Francisco", capacity: 10, price: 70, description: "Beautiful flat in SF heart", address: "635 Sutter St, San Francisco, CA 94102-1017")
...
my_cowork_2 = Cowork.new(city: "Byron-Bay", capacity: 8, price: 60, description: "Awesome place to work !", address: "100 Bangalow Rd, Byron Bay, Nouvelle-Galles du Sud 2481, Australie")
...
my_cowork_3 = Cowork.new(city: "Paris", capacity: 3, price: 80, description: "Cool place with all comodities", address: "16 rue Edmond Roger, Paris")
...
my_cowork_4 = Cowork.new(city: "NY", capacity: 9, price: 75, description: "Calm and full equiped place in NY", address: "1535 Broadway, At 45th Street, New York, NY 10036-4077
")
...
my_cowork_5 = Cowork.new(city: "Sao Paulo", capacity: 5, price: 55, description: "10 min from Sao Paulo center, quiet and cool workplace :)", address: "Rua Haddock Lobo 294, São Paulo, État de São Paulo 01414-000, Brésil")
...
my_cowork_6 = Cowork.new(city: "La Havane", capacity: 13, price: 45, description: "Come work and enjoy with us!", address: "Alameda Santos 1123, São Paulo, État de São Paulo 01419-001, Brésil")
...
my_cowork_7 = Cowork.new(city: "Saint-Malo", capacity: 6, price: 45, description: "Lovely appartment, far from city's noise", address: "8 rue d'Estrées, 35400, Saint-Malo, France")
...
my_cowork_8 = Cowork.new(city: "Marseille", capacity: 13, price: 50, description: "Nice home, near the Bonnemère", address: "6 rue Beauvau, 13001 Marseille, France")
...
my_cowork_9 = Cowork.new(city: "Toulouse", capacity: 15, price: 55, description: "Beautiful place with wifi, and pool!", address: "4 rue Dieudonne Costes, 31700 Blagnac, France")
...
my_cowork_10 = Cowork.new(city: "Berlin", capacity: 10, price: 50, description: "In the best Berlin's area", address: "Monbijouplatz 1, 10178 Berlin, Allemagne")
...
my_cowork_11 = Cowork.new(city: "Amsterdam", capacity: 7, price: 65, description: "Best place to work in Amsterdam", address: "Spuistraat 288-292, 1012 VX Amsterdam, Pays-Bas")
...
my_cowork_12 = Cowork.new(city: "Naples", capacity: 11, price: 45, description: "Peacefull place near the station and the market", address: "Calata San Marco 24, 80133, Naples, Italie")
